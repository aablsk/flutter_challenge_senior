...
I therefore decided to go with an **assumption-based approach** based on the information I have and additional requirements/constraint that I will impose for the project.
...
* code for a maximum of 16 hours 
...
----------
    ...
    As a PO, I want to see all issues of our GitHub repositories to quickly view all issues of one
    project after each other.
...
### *"A technical demo with your account will be needed"*
  Note to self: using newly created account for this task.
...
### **Login screen** *"with common login functionalities"*
...
### **Repository List** *"Shows all relevant information for a repository"*
...
### **Repository List** *"Click to one list item transitions to the issue list of that repository"*

No assumptions necessary, requirement is clear.


### **Issues List** *"Shows all needed information for each issue"*
...
*NOTE* Another screen for issue details would probably make sense to not overload the issue list with detailed information.

### **UI** *"UI should look good on the device you will present. Optimize for that"*

*ASSUMPTION* UI that 'looks good' respects Material Design philosophy.

### **UI** *"The device your App runs on has to be a Phone"*
...
### **UI** *"Dark and light mode should be supported"*

*ASSUMPTION* App should be able to toggle between light mode and dark mode. Two themes have to be created.

*ASSUMPTION* App does not need to automatically switch between dark/light mode based on system setting.

### **Testing** *"write both unit and widget tests where it makes sense"*
...
I do not see the value of high test coverage for this application due to its limited user group and functionality. I see very low value in spending my time on repetitive tasks for an unpaid coding challenge.
...
### **Testing** *"Bonus: flutter driver tests"*

*DECISION* Will write flutter driver tests if I have some leftover time. I will prioritize code quality, architecture and documentation over the bonus task.

### **Technical** *"provider & change notifier for state management."*
